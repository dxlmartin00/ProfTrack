        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-4 bg-white dark:bg-zinc-900">
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="flex h-10 w-full rounded-lg border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 px-3 py-2 text-sm text-zinc-900 dark:text-zinc-100 shadow-2xs font-semibold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950 dark:focus-visible:ring-zinc-400"
            >
              {courses.map((cls) => (
          ...
          {parsedTopics.length === 0 && inputMode === 'paste' && (
            <div className="space-y-3">
              <textarea
                ...
                className="w-full rounded-lg border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 p-3 text-xs sm:text-sm text-zinc-900 dark:text-zinc-100 font-mono shadow-2xs focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950 dark:focus-visible:ring-zinc-400"
              />
              <button
                type="button"
                disabled={!rawPastedText.trim()}
                onClick={handleParsePastedText}
                className="inline-flex h-9 items-center justify-center rounded-lg bg-zinc-950 dark:bg-zinc-100 px-4 text-xs sm:text-sm font-semibold text-white dark:text-zinc-950 shadow-2xs hover:bg-zinc-800 dark:hover:bg-zinc-200 disabled:opacity-50 cursor-pointer"
              >
          ...
          {isProcessing && (
            <div className="py-8 flex flex-col items-center justify-center gap-2.5">
              ...
              <p className="text-xs font-bold text-zinc-800 dark:text-zinc-200">Parsing Word Document Syllabus...</p>
            </div>
          )}
            ...
            <div className="space-y-3">
                ...
                {parsedTopics.map((topic, index) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="text-zinc-400 hover:text-red-600 dark:hover:text-red-400 p-1 transition-colors cursor-pointer shrink-0 opacity-0 group-hover:opacity-100"
                      title="Remove topic"
                    >
              ...
              <div className="flex items-center gap-2 pt-1">
                ...
                <button
                  ...
                  className="inline-flex h-9 items-center justify-center rounded-lg border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 px-3 text-xs font-semibold text-zinc-800 dark:text-zinc-200 hover:bg-zinc-100 dark:hover:bg-zinc-700 cursor-pointer shrink-0"
                >
